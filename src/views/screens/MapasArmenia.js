            ...
            <MapView style={styles.map}
                ...
                {odontologias.map(odontologia => (
                    <Marker
                        ...
                        coordinate={{ latitude: odontologia.lat, longitude: odontologia.lng }}
                        title={odontologia.nombre}
                        image={{ uri: "https://res.cloudinary.com/dsot09sfy/image/upload/v1684465012/maps-footer_wgu1et.png" }} // Asegúrate de tener la imagen en la ruta correcta
                    />
                ))}
            </MapView>
        </View>
